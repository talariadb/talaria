...
var file_talaria_proto_rawDesc = []byte{
	...
	0x06, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x22, 0x68, 0x0a, 0x09, 0x54, 0x61, 0x62, 0x6c, 0x65,
	...
	0x73, 0x22, 0x4e, 0x0a, 0x0a, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x12,
	...
	0x65, 0x22, 0x00, 0x32, 0xd0, 0x01, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x41, 0x0a,
	...
	,
}
...
var file_talaria_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_talaria_proto_goTypes = []interface{}{
	...
	(*TableMeta)(nil),              // 8: talaria.TableMeta
	(*ColumnMeta)(nil),             // 9: talaria.ColumnMeta
	(*GetSplitsRequest)(nil),       // 10: talaria.GetSplitsRequest
	(*GetSplitsResponse)(nil),      // 11: talaria.GetSplitsResponse
	(*Endpoint)(nil),               // 12: talaria.Endpoint
	(*Split)(nil),                  // 13: talaria.Split
	(*GetRowsRequest)(nil),         // 14: talaria.GetRowsRequest
	(*GetRowsResponse)(nil),        // 15: talaria.GetRowsResponse
	(*Column)(nil),                 // 16: talaria.Column
	(*ColumnOfInt32)(nil),          // 17: talaria.ColumnOfInt32
	(*ColumnOfInt64)(nil),          // 18: talaria.ColumnOfInt64
	(*ColumnOfFloat64)(nil),        // 19: talaria.ColumnOfFloat64
	(*ColumnOfBools)(nil),          // 20: talaria.ColumnOfBools
	(*ColumnOfString)(nil),         // 21: talaria.ColumnOfString
	nil,                            // 22: talaria.Batch.StringsEntry
	nil,                            // 23: talaria.Event.ValueEntry
}
var file_talaria_proto_depIdxs = []int32{
	...
	22, // 2: talaria.Batch.strings:type_name -> talaria.Batch.StringsEntry
	4,  // 3: talaria.Batch.events:type_name -> talaria.Event
	23, // 4: talaria.Event.value:type_name -> talaria.Event.ValueEntry
	8,  // 5: talaria.DescribeResponse.tables:type_name -> talaria.TableMeta
	9,  // 6: talaria.TableMeta.columns:type_name -> talaria.ColumnMeta
	13, // 7: talaria.GetSplitsResponse.splits:type_name -> talaria.Split
	12, // 8: talaria.Split.hosts:type_name -> talaria.Endpoint
	16, // 9: talaria.GetRowsResponse.columns:type_name -> talaria.Column
	17, // 10: talaria.Column.int32:type_name -> talaria.ColumnOfInt32
	18, // 11: talaria.Column.int64:type_name -> talaria.ColumnOfInt64
	19, // 12: talaria.Column.float64:type_name -> talaria.ColumnOfFloat64
	21, // 13: talaria.Column.string:type_name -> talaria.ColumnOfString
	20, // 14: talaria.Column.bool:type_name -> talaria.ColumnOfBools
	18, // 15: talaria.Column.time:type_name -> talaria.ColumnOfInt64
	21, // 16: talaria.Column.json:type_name -> talaria.ColumnOfString
	5,  // 17: talaria.Event.ValueEntry.value:type_name -> talaria.Value
	0,  // 18: talaria.Ingress.Ingest:input_type -> talaria.IngestRequest
	1,  // 19: talaria.Ingress.IngestWithTable:input_type -> talaria.IngestWithTableRequest
	6,  // 20: talaria.Query.Describe:input_type -> talaria.DescribeRequest
	10, // 21: talaria.Query.GetSplits:input_type -> talaria.GetSplitsRequest
	14, // 22: talaria.Query.GetRows:input_type -> talaria.GetRowsRequest
	2,  // 23: talaria.Ingress.Ingest:output_type -> talaria.IngestResponse
	2,  // 24: talaria.Ingress.IngestWithTable:output_type -> talaria.IngestResponse
	7,  // 25: talaria.Query.Describe:output_type -> talaria.DescribeResponse
	11, // 26: talaria.Query.GetSplits:output_type -> talaria.GetSplitsResponse
	15, // 27: talaria.Query.GetRows:output_type -> talaria.GetRowsResponse
...
func file_talaria_proto_init() {
	...
	file_talaria_proto_msgTypes[16].OneofWrappers = []interface{}{
		(*Column_Int32)(nil),
		(*Column_Int64)(nil),
		(*Column_Float64)(nil),
		(*Column_String_)(nil),
